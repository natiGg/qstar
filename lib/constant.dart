...
Color mPrimaryLight = const Color(0xFF6B60B6);
Color mPrimaryvLight = const Color(0xFFBDB8DF);

Color mPrimaryTextColor = const Color(0xFFae3d99);

Color mSecondTextColor = const Color(0xFFae3d99);

Color mSecondColor = const Color(0xFFC28E79);

Color mFacebookColor = const Color(0xFF4277BC);

Color mTitleTextColor = const Color(0xFF2D140D);
...
Color kAccentColor = Color(0xffFCAAAB);
Color kAccentColorVariant = Color(0xffF7A3A2);
Color kUnreadChatBG = Color(0xffEE1D1D);
...
final TextStyle bodyText1 = TextStyle(
    color: Color(0xffAEABC9), fontSize: 10, fontWeight: FontWeight.w500);
