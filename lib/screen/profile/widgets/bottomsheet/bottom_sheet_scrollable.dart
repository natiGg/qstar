...
class BottomSheetScrollable2 extends StatelessWidget {
  final List<BottomSheetAction2> actions;
  final ScrollController scrollController;

  // ignore: use_key_in_widget_constructors
  const BottomSheetScrollable2(
      {required this.actions, required this.scrollController});
        ...
        Expanded(
          ...
          child: Material(
            ...
            child: SafeArea(
              ...
              controller: scrollController,
              children: actions
                  .map((action) => BottomSheetActionWidget2(action))
                  .toList(),
            )),
          ),
        ))
